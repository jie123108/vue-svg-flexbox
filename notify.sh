...
url=https://api.github.com/repos/jie123108/vue-svg-flexbox/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "vue-svg-flexbox更新", "text": "@所有人\n# [vue-svg-flexbox]('$html_url')\n'$body'"}}'
